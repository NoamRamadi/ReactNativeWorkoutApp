  ...
  const updateSetDetails = (
    ...
    setSelectedExercises((prev) => {
      ...
      if (updatedExercises[exerciseIndex]) {
        const currentValue = updatedExercises[exerciseIndex].sets[setIndex][field] || '';
  
        if (value === 'delete') {
          // Remove the last character
          updatedExercises[exerciseIndex].sets[setIndex][field] = currentValue.slice(0, -1);
        } else {
          // Append the new value
          updatedExercises[exerciseIndex].sets[setIndex][field] = currentValue + value;
        }
      }
